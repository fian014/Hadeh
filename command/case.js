...
//start script
			async function starts() {
				...
				haruka.on('qr', () => {
					console.log(color('[','white'), color('!','red'), color(']','white'), color('SCAN QR MASK 15 SECONDS, bismillah'))
					})
...
case 'menu': case 'help': case 'oi':
				...
				break
case 'infobot':
reply('Nunggu Fian///>*Id Game* /•_• _Mobile Legends_ : 197837997 />.< _Ghensin Impact_ : 811852036 /:) _Punishing Gray Raven_ : 17465086 ')
break
case 'owner':{
